...
process.GlobalTag.toGet = cms.VPSet(
    cms.PSet(record = cms.string('SiPixelGainCalibrationRcd'),
             ...
             connect = cms.string('sqlite_file:/afs/cern.ch/work/t/tsusacms/public/2017_09/CMSSW_9_2_12/src/DPGAnalysis-SiPixelTools/LA-Calibration/makeTrees/reReco_gainCalibFull/SiPixelGainCalibration_2017_v6_full.db')))
