...
process.GlobalTag.toGet = cms.VPSet(
    cms.PSet(record = cms.string('SiPixelGainCalibrationRcd'),
             ...
             connect = cms.string('sqlite_file:/afs/cern.ch/work/b/bmesic/public/17_10_pixel_tree_production/CMSSW_9_2_12/src/DPGAnalysis-SiPixelTools/PixelTrees/PixelTree-ProductionTool/gainPBPv6_65/SiPixelGainCalibration_2017_v6_full.db')))
